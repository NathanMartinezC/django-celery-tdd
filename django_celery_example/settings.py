...
SECRET_KEY = 'django-insecure-ll%_1y9bxvg+@t8nf2_^e4d7ec2nwt0=+6jihgvn+z5qlcd+kv'
...
CHANNEL_LAYERS = {
    'default': {
        ...
        'CONFIG': {
            "hosts": [
                (os.environ.get("CHANNELS_REDIS", "redis://127.0.0.1:6379/0"))
            ],
        },
    },
}
...
# Force all queued to be explicitly listed in 'CELERY_TASK_QUEUES' to help prevent typos
